    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alcoholic', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drinking_habits', models.CharField(blank=True, max_length=255, null=True)),
                ('diet', models.CharField(blank=True, max_length=255, null=True)),
                ('personal_value', models.CharField(blank=True, max_length=255, null=True)),
                ('any_disabblity', models.CharField(blank=True, max_length=255, null=True)),
                ('family_value', models.CharField(blank=True, max_length=255, null=True)),
                ('prefered_state', models.CharField(blank=True, max_length=255, null=True)),
                ('complexion', models.CharField(blank=True, max_length=255, null=True)),
                ('with_children_accpetance', models.CharField(blank=True, max_length=255, null=True)),
                ('smoking_habits', models.CharField(blank=True, max_length=255, null=True)),
                ('body_type', models.CharField(blank=True, max_length=255, null=True)),
                ('manglik', models.CharField(blank=True, max_length=255, null=True)),
                ('mother_tongue', models.CharField(blank=True, max_length=255, null=True)),
                ('prefered_country', models.CharField(blank=True, max_length=255, null=True)),
                ('prefered_status', models.CharField(blank=True, max_length=255, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
