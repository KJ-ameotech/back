...
urlpatterns = [
    ...
    path('api/preferences/', PreferenceDetailView.as_view(), name='preference-detail'),
   ...
   # path('password-change/', ChangePassword.as_view(), name='change-password'),
    ...
    path('delete-image/<int:user_id>/<int:image_id>/', DeleteUserImageView.as_view(), name='delete-user-image'),
]
